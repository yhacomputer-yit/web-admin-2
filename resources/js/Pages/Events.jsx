                            ...
                            {events.data.map((event, index) => (
                                <div key={event.id} className="event-card">
                                    <div className="row g-0 align-items-center">
                                        {index % 2 === 0 ? (
                                            <>
                                                {/* First, third items... image left, content right */}
                                                <div className="col-lg-6">
                                                    <img src={`/storage/${event.image}`} className="event-image" alt={event.title} />
                                                </div>
                                                <div className="col-lg-6">
                                                    <div className="event-content">
                                                        ...
                                                        <div className="event-description">
                                                            {event.aboute?.replace(/<[^>]*>/g, '')}
                                                        </div>
                                                        <div className="event-btn-row">
                                                            <Link href={`/yha/eventDetail/${event.id}`} className="event-btn">
                                            ...
                                            <>
                                                {/* Second, fourth items... content left, image right */}
