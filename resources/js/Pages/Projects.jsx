                ...
                <div className="container">
                    <div className="course-filter">
                        <div className="filter-buttons">
                            <Link href="/yha/project/1" className="filter-btn">
                                <i className="fa-solid fa-code me-2"></i>
                                Programming
                            </Link>
                            <Link href="/yha/project/2" className="filter-btn">
                                    ...
                                    <div className="project-card">
                                        ...
                                        <div className="project-content">
                                            <h5 className="project-title">
                                                <Link href={`/yha/projects/${project.id}`} className="project-title-link">{project.title}</Link>
                                            </h5>
