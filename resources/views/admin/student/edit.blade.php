    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-12">
                ...
                <a href="{{ route('admin.course') }}" class="btn" style="background: #ff6c0f; color:white;"> <i class="bx bx-left-arrow-alt"></i> Back</a>

                <div class="card my-3 border-warning shadow">
                    {{-- Card Header  --}}
                    <div class="card-header border-warning">
                        <h3 style="color: #ff6c0f;" class="h5"> <i class="bx bx-user fs-3"></i> Edit Student</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form class="" action="{{ route('student.update', ['id' => $student->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex mt-2">
                                        <div class="form-check form-check-inline">
                                            <input style="font-size: 17px;"
                                                ...
                                                name="gender"
                                                id="inlineRadio1"
                                                value="1" {{ $student->gender == 1 ? 'checked' : '' }} />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        <input style="font-size: 17px;"
                                            ...
                                            name="township"
                                            class="form-control"
                                            value="{{ old('township', $student->township) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea style="font-size: 17px;"
                                    ...
                                    name="education"
                                    class="form-control"
                                    placeholder="Background Education">{{ old('education', $student->education) }}</textarea>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-6">
                                    <label style="font-size:16px;" for="" class="mb-2">Status</label>
                                    <select id="defaultSelect" name="status" class="form-select">
                                        <option value="1" {{ $student->status == 1 ? 'selected' : '' }}>Enroll</option>
                                        <option value="0" {{ $student->status == 0 ? 'selected' : '' }}>Panding</option>
                                    </select>
                                </div>
                                <div class="col-6">
                                    ...
                                    <input style="font-size: 17px;"
                                        ...
                                        type="date"
                                        name="enroll_date"
                                        value="{{ old('enroll_date', $student->enroll_date) }}"
                                        id="html5-datetime-local-input" />
                                </div>
                            </div>
                            <!-- Image  -->
                            <div class="mb-3 row">
                                <div class="col-6">
                                    <label style="font-size:16px;" for="formFile" class="form-label">Image</label>
                                    <input style="font-size: 17px;" class="form-control" type="file" id="formFile" name="image" />
                                </div>
                                <div class="col-6">
                                    <img style="width:100px; border-radius: 10px;" id="img" src="{{ asset('storage/' . $student->image) }}" alt="{{ $student->name }} Image">
                                </div>
                            </div>

                            <button style="background: #ff6c0f; color:white;" type="submit" class="btn">Update</button>
                        </form>
