                            ...
                            @csrf
                              ...
                              <div class="row">
                                <div class="col-md-6 mb-3">
                                  <label style="font-size:16px;" for="" class="col-form-label">Register Date</label>
                                    <input style="font-size: 17px;"
                                        class="form-control"
                                        name="register_data"
                                        type="datetime-local"
                                ...
                                <div class="col-md-6 mb-3">
                                  <label style="font-size:16px;" for="" class="col-form-label">End Date</label>
                                    <input style="font-size: 17px;"
                                        class="form-control"
                                        type="date"
                                        name="end_date"
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="col-6">
                                  <img style="width:100px; border-radius: 1 0px;" id="img" src="" alt="">
                                </div>
                              </div>
